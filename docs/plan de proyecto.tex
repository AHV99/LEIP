...
Este documento es la versi\'on vigente del plan. No se considera cerrado: se
actualiza cuando cambian el alcance, el cronograma o la organizaci\'on del
trabajo, y cada cambio queda asentado en el historial de revisiones.
...
\begin{itemize}[leftmargin=1em]
  ...
  \item Actualizaci\'on de toda la documentaci\'on a su versi\'on vigente y preparaci\'on de la defensa de tesis.
\end{itemize} \\
...
El criterio de aceptaci\'on del proyecto se define en base al alcance de la primera etapa del producto y al plan de validaci\'on. Este criterio deber\'a validarse formalmente con el tutor de tesis y, de corresponder, con usuarios/organizaciones que participen de la validaci\'on del producto.
