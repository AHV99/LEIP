...
1.4 & 12/09/2026 & Revisi\'on de redacci\'on: se elimina la escritura defensiva ---atenuantes, futuros evasivos, descargos repetidos y los p\'arrafos que declaraban el estado del propio documento--- y se afirman en presente las decisiones ya tomadas & Equipo \\
\end{historial}
...
Esta secci\'on delimita qu\'e cubre y qu\'e no cubre el documento.
...
BCCh    & Banco Central de Chile. Banco central de Chile; su encuesta de expectativas queda fuera de la primera etapa. \\
...
su frecuencia de publicaci\'on y su situaci\'on respecto del alcance inicial.
...
\toprule
\textbf{Pa\'is} & \textbf{Fuente} & \textbf{Frecuencia y situaci\'on} \\
\midrule
...
Chile   & Encuesta de Expectativas Econ\'omicas (BCCh) & Mensual. Fuera de la primera etapa: su incorporaci\'on requiere la autorizaci\'on de uso del organismo. \\
\bottomrule
\end{tabularx}
\end{table}
...
Los procesos de extracci\'on se apoyan en una arquitectura de agentes que
coordina la obtenci\'on, interpretaci\'on y validaci\'on de fuentes
heterog\'eneas bajo controles determin\'isticos de calidad y trazabilidad. La
...
Las capacidades siguientes constituyen el alcance funcional de la primera etapa
del producto:
...
alguna de ellas no se cumple, el alcance de la primera etapa debe revisarse.
...
\begin{itemize}
  ...
  \item Los formatos de publicaci\'on se mantienen estables, o sus cambios son
        detectables por validaci\'on autom\'atica.
...
Aplicando estos criterios, el orden de construcci\'on es el siguiente:
