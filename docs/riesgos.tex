...
1.2 & 12/09/2026 & Revisi\'on de redacci\'on: se retira el p\'arrafo sobre el estado del propio documento y se remite a la secci\'on de seguimiento & Equipo \\
\end{historial}
\clearpage
...
acci\'on prevista para el caso de que ocurra de todos modos. La secci\'on
\ref{sec:seguimiento} define c\'omo se revisa y en qu\'e estados puede estar
cada riesgo.
