...
Este documento es la versi\'on vigente de la arquitectura. No se considera
cerrado: cada decisi\'on nueva se agrega como una ficha adicional y las
decisiones revertidas se marcan como superadas en lugar de eliminarse, para
conservar el razonamiento que llev\'o a ellas.
...
La informaci\'on se organizar\'a mediante el patr\'on Medallion, que separa el
...
Esta secci\'on desarrollar\'a el dise\~no interno de cada componente: la
estructura de m\'odulos del backend, la organizaci\'on del motor de m\'etricas y
su grafo de dependencias, la composici\'on del frontend y los contratos de
comunicaci\'on entre componentes.
