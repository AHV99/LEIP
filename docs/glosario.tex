...
\begin{historial}
1.0 & 26/06/2026 & Versi\'on inicial del glosario & Equipo \\
1.1 & 11/09/2026 & Alineaci\'on terminol\'ogica con el Documento de Visi\'on: se retira el t\'ermino MVP, se incorporan primera etapa, integraci\'on program\'atica y matriz de fuentes & Equipo \\
1.2 & 12/09/2026 & Revisi\'on de redacci\'on: se retiran los atenuantes de las entradas cuya decisi\'on ya est\'a tomada & Equipo \\
\end{historial}
\clearpage

\section{Glosario general}

Este glosario re\'une los t\'erminos, siglas y convenciones de nomenclatura que
se utilizan en toda la documentaci\'on de \proyectoNombre{}. Su prop\'osito es
que un mismo concepto se nombre siempre de la misma forma y tenga una \'unica
definici\'on de referencia, evitando que cada documento la repita o la
redefina.

La tabla siguiente presenta los t\'erminos ordenados alfab\'eticamente, con su
definici\'on y el contexto de \proyectoNombre{} en el que se aplica.
...
Azure Blob Storage & Servicio de almacenamiento de objetos donde se conservan los archivos originales, documentos hist\'oricos, datos en cuarentena y exportaciones. \\
\addlinespace

Azure Container Apps & Servicio sobre el que se despliegan los contenedores Docker de los distintos componentes de \proyectoNombre{}, facilitando su desacoplamiento, despliegue y escalabilidad. \\
\addlinespace
...
Banxico & Banco de M\'exico. Fuente oficial de la informaci\'on econ\'omica de M\'exico. \\
\addlinespace

BCB & Banco Central do Brasil. Fuente oficial de la informaci\'on econ\'omica de Brasil. \\
\addlinespace

BCCh & Banco Central de Chile. Fuente oficial de la informaci\'on econ\'omica de Chile; queda fuera de la primera etapa hasta obtener autorizaci\'on expresa para el uso previsto. \\
\addlinespace

BCU & Banco Central del Uruguay. Fuente oficial de la informaci\'on econ\'omica de Uruguay. \\
\addlinespace
...
CI/CD & \emph{Continuous Integration / Continuous Delivery or Deployment}. Proceso de integraci\'on y despliegue continuo, implementado con GitHub Actions. \\
\addlinespace
...
Cruce entre m\'odulos & Relaci\'on anal\'itica calculada entre informaci\'on de dominios diferentes. En la primera etapa se contemplan inflaci\'on esperada frente a observada y crecimiento esperado frente a actividad efectiva. \\
\addlinespace
...
GitHub Actions & Herramienta con la que se implementa el proceso de CI/CD. \\
\addlinespace
...
Integraci\'on program\'atica & Mecanismo por el cual un sistema externo consulta datos y m\'etricas de \proyectoNombre{} de forma automatizada, sin intervenci\'on manual. En la arquitectura propuesta se implementa mediante la API institucional. \\
\addlinespace
...
Matriz de fuentes & Registro vivo que documenta, para cada conjunto de datos incorporado, la instituci\'on emisora, la URL, la fecha de consulta, el m\'etodo de acceso, las condiciones de uso, la atribuci\'on requerida y qu\'e est\'a permitido hacer con \'el en materia de almacenamiento, transformaci\'on, hist\'oricos, exportaci\'on y redistribuci\'on. Ning\'un conjunto de datos se incorpora al producto sin su entrada correspondiente. \\
\addlinespace
...
M\'odulo individual & Plan que brinda acceso completo al m\'odulo contratado; se pueden contratar hasta tres m\'odulos individuales antes de migrar al plan Completo. \\
\addlinespace
...
Pandas & Biblioteca de Python utilizada para el procesamiento y la transformaci\'on de datos. \\
\addlinespace
...
PostgreSQL & Base de datos donde se almacenan los datos normalizados, m\'etricas, hist\'oricos, revisiones, usuarios, organizaciones, permisos y registros de auditor\'ia. \\
\addlinespace
...
Primera etapa & Alcance inicial del producto: los pa\'ises, m\'odulos y capacidades que se construyen primero, definidos en el Documento de Visi\'on. Lo que queda fuera se aborda en etapas posteriores; la expresi\'on sustituye al t\'ermino MVP en toda la documentaci\'on. \\
\addlinespace
...
SLA & \emph{Service Level Agreement}. Compromiso de nivel de servicio incluido en el plan Enterprise. \\
\addlinespace
...
USD & D\'olar estadounidense. Moneda de las estimaciones de precios y costos del Documento de Negocio. \\
\addlinespace
