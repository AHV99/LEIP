...
redefina. Se mantiene actualizado: cuando un documento incorpora un t\'ermino
nuevo o cambia el significado de uno existente, el cambio se refleja aqu\'i.

La tabla siguiente presenta los t\'erminos ordenados alfab\'eticamente, con su
definici\'on y, cuando corresponde, el contexto de \proyectoNombre{} en el que
se aplica.
...
BCCh & Banco Central de Chile. Fuente considerada para Chile; su incorporaci\'on queda fuera de la primera etapa mientras no exista autorizaci\'on expresa suficiente para el uso previsto. \\
\addlinespace
...
USD & D\'olar estadounidense. Moneda utilizada en las estimaciones preliminares de precios y costos del Documento de Negocio. \\
\addlinespace
